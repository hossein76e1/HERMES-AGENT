...
§
WhatsApp removed 2026-09-08 → Telegram assistant @Hosseinagentcoderbot (projects/telegram_assistant/, TELEGRAM_ASSISTANT_TOKEN in .env). Reminders/tasks/shopping per chat_id WITHOUT AI (JobQueue, TZ +03:30); AI chat via GLM. 3 reminders migrated. survey_bot /msg & /chat → admin→customer WITHOUT AI.
§
